            ...
            + json.dumps(
                {
                    ...
                    "get_obs_ms": round((observed - request_started) * 1000, 3),
                    "policy_update_obs_ms": round((uploaded - observed) * 1000, 3),
                    "policy_get_action_ms": round((received - uploaded) * 1000, 3),
                    "request_total_ms": round((received - request_started) * 1000, 3),
                    "execute_steps": prefix_steps,
                }
            ),
            flush=True,
        )
