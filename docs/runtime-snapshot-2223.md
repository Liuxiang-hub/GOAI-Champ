...
> Historical record, not a live status report. The parameters, mappings and
> replay notes below describe the archived 2223 snapshot and do not participate
> in the current synchronous-prefix deployment.
